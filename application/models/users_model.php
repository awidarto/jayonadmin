...
class Users_model extends CI_Model
{
	...
	public function __construct()
	{
		...
		log_message('debug', 'Users Model Loaded');
	...
	public function register($username, $password, $email, $group_id)
	{
		if($this->db->set('username', $username)->set('password', $password)->set('email', $email)->set('group_id', $group_id)->insert($this->user_table))
		{
			return TRUE;
		}
