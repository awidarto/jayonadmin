...
<html lang="en">
   <head>
      <meta charset="utf-8">
    <title>DELIVERY REPORT - PT JEXINDO SUKSES MAKMUR</title>
    ...
    <body>
        <div id="head">
            ...
            <div style="width:400px;display:inline-block;">
                <h1 style="margin-top:0px;">DELIVERY REPORT</h1>
                <h2>No: JSM-DELIVERY-<?php print strtoupper($merchantname) ?>-<?php print $invdatenum ?></h2>
                <?php print $sumtab; ?>
            </div>
        </div>
