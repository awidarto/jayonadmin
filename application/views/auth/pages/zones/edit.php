...
<div id="form">
	<div class="form_box">
			<form method="post" action="<?php echo site_url('admin/zones/edit/'.$user['id'])?>">
			District:<br />
			<input type="text" name="district" id="district" size="50" class="form" value="<?php echo set_value('district',$user['district']); ?>" /><br /><?php echo form_error('district'); ?><br />
			...
			Province:<br />
			<input type="text" name="province" id="province" size="50" class="form" value="<?php echo set_value('province',$user['province']); ?>" /><?php echo form_error('province'); ?><br /><br />
