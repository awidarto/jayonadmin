	...
	$(document).ready(function() {
		...
		$('table.dataTable').click(function(e){
			...
			if ($(e.target).is('.delete_link')) {
				...
				if (answer){
					$.post('<?php print site_url('admin/zones/ajaxdelete');?>',{'id':zone_id}, function(data) {
						if(data.result == 'ok'){
							//redraw table
							oTable.fnDraw();
			...
			if ($(e.target).is('.onswitch_link')) {
				...
				if (answer){
					$.post('<?php print site_url('admin/zones/ajaxtoggle');?>',{'id':zone_id,'switchto':nextsw}, function(data) {
						if(data.result == 'ok'){
							//redraw table
							oTable.fnDraw();
						}
