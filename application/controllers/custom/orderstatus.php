...
class Orderstatus extends Application
{
    ...
    public function report($type = null,$deliverytype = null,$zone = null,$merchant = null,$year = null, $scope = null, $par1 = null, $par2 = null, $par3 = null,$par4 = null){
        ...
        */
        ...
        $this->breadcrumb->add_crumb('Order Status Report','custom/orderstatus/report');
        ...
        $data['controller'] = 'custom/orderstatus/report/';
        ...
        if($pdf == 'pdf'){
            ...
            $this->load->view('auth/pages/custom/print/orderstatusprint',$data); // Load the view
        }else{
            //$this->load->view('custom/orderstatusgenerator',$data); // Load the view
            $this->ag_auth->view('custom/orderstatusgenerator',$data); // Load the view
        }
    }
