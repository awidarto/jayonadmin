		...
		if(logged_in())
		{
            ...
            */
            ...
            $sq = $this->db->select('merchant_id, date(pickuptime) as pickupdate,status')
                ...
                //->where($intab.'.assignment_date <=',$endtime)
                //->and_()
                ->where_in('status',array('pending','cr_assigned','date_assigned','confirmed','zone_assigned','dev_assigned'))
            ...
            $this->table->set_heading(
                ...
                array('data'=>'Device Zone Assignment','rowspan'=>2,'style'=>'text-align:center;'),
                array('data'=>'Courier Assignment','rowspan'=>2,'style'=>'text-align:center;'),
                array('data'=>'In Progress','rowspan'=>2,'style'=>'text-align:center;'),
